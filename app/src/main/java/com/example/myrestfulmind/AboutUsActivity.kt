...
class AboutUsActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val faqs: TextView = findViewById(R.id.txtFaq)
        ...
        val term: TextView = findViewById(R.id.txtTerms)
        term.setOnClickListener(View.OnClickListener {
            val registerIntent = Intent(this@AboutUsActivity, TermsActivity::class.java)
            startActivity(registerIntent)
        })
